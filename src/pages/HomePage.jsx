...
// HomePage.jsx - UPDATED WITH MOBILE SIDEBAR TOGGLES
import React, { useState, useEffect, useCallback } from "react";
import { Modal, Form, Button, Spinner } from "react-bootstrap";
import SideBar from "../components/home/SideBar";
import CreatePost from "../components/home/post/CreatePost";
...
const HomePage = () => {
  ...
  // NEW: Toggle functions for mobile
  ...
  // NEW: Close sidebars when clicking overlay
  const closeSidebars = () => {
    setShowLeftSidebar(false);
    setShowRightSidebar(false);
  };
  ...
  if (loading && posts.length === 0) {
    return (
      <div className="homepage-container">
        ...
        <div className="container-fluid">
          <div className="row g-4">
            <div className={`col-lg-3 ${showLeftSidebar ? 'mobile-open' : ''}`}>
              <SideBar 
                currentUser={currentUser} 
            ...
            <div className={`col-lg-3 ${showRightSidebar ? 'mobile-open' : ''}`}>
              <FriendsList 
                currentUser={currentUser} 
