// FIXED ProductModal.jsx - Direct chat navigation with proper opening
  ...
  const handleChat = async () => {
    ...
    try {
      ...
      if (res.success && res.data?.conversationId) {
        ...
        // ✅ Navigate to chat page with both conversation ID and full data
        navigate('/chat', { 
          state: { 
            conversationId: res.data.conversationId,
            conversationData: res.data.conversation, // Include full conversation data
