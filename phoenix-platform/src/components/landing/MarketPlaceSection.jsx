              ...
              <div  className="w-75">
                ...
                <div className="row py-4 d-flex flex-wrap gap-4 justify-content-center">
                    <motion.div
                        ...
                        <div className="py-3">
                            <img src="/src/assets/woodTable.png" alt="woodTable" className="img-fluid w-100" />
                    ...
                    <motion.div
                          whileHover={{ scale: 0.9 }} className="col-md-5 col-9 col-sm-7 col-lg-3 shadow rounded">
                        <div className="py-3">
                            <img src="/src/assets/bag.png" alt="woodTable" className="img-fluid w-100" />
                    ...
                    <motion.div
                          whileHover={{ scale: 0.9 }} className="col-md-5 col-9 col-sm-7 col-lg-3 shadow rounded">
                        <div className="py-3">
                            <img src="/src/assets/glassPlantersSet.png" alt="woodTable" className="img-fluid w-100" />
                            <h5 className="mt-3">Glass Planters Set</h5>
                            <p>Upcycled wine bottles transformed</p>
                    ...
                    <motion.div
                          whileHover={{ scale: 0.9 }}className="col-md-5 col-9 col-sm-7 col-lg-3 shadow rounded">
                        <div className="py-3">
                            <img src="/src/assets/metalArtSculpture.png" alt="woodTable" className="img-fluid w-100" />
